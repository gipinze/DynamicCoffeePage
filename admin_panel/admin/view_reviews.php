        ...
        <?php 
			...
			<div class="main-content">
                ...
                <div class="reviews_stat">
                    ...
                    <input type="hidden" id="hidden-stats" value="<?php echo isset($month_array) ? $month_array : ''; ?>" />
                    <input type="hidden" id="hidden-stars" value="<?php echo isset($star_array) ? $star_array : ''; ?>" />
                    <input type="hidden" id="hidden-average" value="<?php echo isset($average_rating_month_array) ? $average_rating_month_array : ''; ?>" />
